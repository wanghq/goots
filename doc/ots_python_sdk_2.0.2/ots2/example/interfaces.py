...
def main():
    ...
    reserved_throughput = ReservedThroughput(CapacityUnit(3000, 3000))
    ...
    # update_table
    try:
        # 由于刚创建表，需要10分钟之后才能调整表的预留读写吞吐量。
        reserved_throughput = ReservedThroughput(CapacityUnit(5000, 5000))
